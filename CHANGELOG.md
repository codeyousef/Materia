...
- **Text geometry layout**: Glyph advances, kerning, line offsets, alignment, and baseline placement now remain in output units instead of being scaled a second time during path transformation.

### Tests

- Added common geometry regressions for multi-character advances, multiline spacing, centered alignment, and baseline offsets.
