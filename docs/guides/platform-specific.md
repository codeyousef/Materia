...
kotlin {
    ...
    sourceSets {
        val jvmMain by getting {
            dependencies {
                implementation("io.materia:materia-jvm:0.4.2.1")
...
kotlin {
    ...
    sourceSets {
        val jsMain by getting {
            dependencies {
                implementation("io.materia:materia-js:0.4.2.1")
            }
        }
    }
}
...
kotlin {
    ...
    sourceSets {
        val androidMain by getting {
            dependencies {
                implementation("io.materia:materia-android:0.4.2.1")
...
kotlin {
    ...
    sourceSets {
        val nativeMain by creating {
            ...
            dependencies {
                implementation("io.materia:materia-native:0.4.2.1")
            }
        }
