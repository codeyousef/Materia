...
This example visualises a mid-sized knowledge graph and lets you toggle between TF-IDF and semantic edge weighting. Positions tween over 500 ms so you can see how the re-rank changes cluster density.
