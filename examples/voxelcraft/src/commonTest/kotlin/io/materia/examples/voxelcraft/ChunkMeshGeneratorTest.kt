...
class ChunkMeshGeneratorTest {
    ...
    fun testSingleBlockRendersAllSixFaces() = runTest {
        ...
        assertEquals(
            72,
            positions.size,
            "Single block should have 72 position floats (6 faces * 4 vertices * 3 coords)"
        )
        ...
        assertEquals(
            36,
            indices.size,
            "Single block should have 36 indices (6 faces * 2 triangles * 3 indices)"
        )
    }
    ...
    fun testTwoAdjacentBlocksShareFace() = runTest {
        ...
        assertEquals(
            120,
            positions.size,
            "Two adjacent blocks should have 120 position floats (10 faces)"
        )
