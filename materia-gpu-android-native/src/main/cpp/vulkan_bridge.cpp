...
// Utility ------------------------------------------------------------------
    ...
    VkRenderPass
    getOrCreateRenderPass(VulkanDevice &device, VkFormat format, VkImageLayout finalLayout) {
...
// ----------------------------------------------------------------------------
    ...
    Id createDeviceInternal(VulkanInstance &instance, bool preferHighPerformance) {
        ...
        if (device->timelineSupported) {
            ...
            if (vkCreateSemaphore(deviceHandle, &semaphoreInfo, nullptr,
    ...
    acquireFrameInternal(VulkanDevice &device, VulkanSurface &surface, VulkanSwapchain &swapchain) {
        ...
        if (device.timelineSupported) {
            if (swapchain.lastSubmittedValue > swapchain.completedValue) {
                ...
                if (device.dispatch.waitSemaphores == nullptr ||
                    device.dispatch.waitSemaphores(device.device, &waitInfo, UINT64_MAX) !=
                    VK_SUCCESS) {
    ...
    void destroyInstance(std::uint64_t instanceId) {
        ...
        if (instancePtr->debugMessenger != VK_NULL_HANDLE) {
            auto destroyMessenger = reinterpret_cast<PFN_vkDestroyDebugUtilsMessengerEXT>(
                    vkGetInstanceProcAddr(instancePtr->instance,
...
Java_io_materia_gpu_bridge_VulkanBridge_vkInit(JNIEnv *env, jclass, jstring appName,
                                               jboolean enableValidation) {
    const char *name = env->GetStringUTFChars(appName, nullptr);
    std::uint64_t id = materia::vk::createInstance(name, enableValidation == JNI_TRUE);
    env->ReleaseStringUTFChars(appName, name);
    return static_cast<jlong>(id);
}

JNIEXPORT jlong JNICALL
Java_io_materia_gpu_bridge_VulkanBridge_vkCreateSurface(JNIEnv *env, jclass, jlong instanceId,
                                                        jobject surface) {
    std::lock_guard<std::mutex> lock(g_registryMutex);
...
JNIEXPORT jlong JNICALL
Java_io_materia_gpu_bridge_VulkanBridge_vkCreateDevice(JNIEnv *env, jclass, jlong instanceId) {
    (void) env;
    std::lock_guard<std::mutex> lock(g_registryMutex);
...
JNIEXPORT jlong JNICALL
Java_io_materia_gpu_bridge_VulkanBridge_vkCreateSwapchain(JNIEnv *env, jclass, jlong instanceId,
                                                          jlong deviceId, jlong surfaceId,
                                                          jint width, jint height) {
    (void) env;
    std::lock_guard<std::mutex> lock(g_registryMutex);
    return static_cast<jlong>(materia::vk::createSwapchain(static_cast<std::uint64_t>(instanceId),
...
Java_io_materia_gpu_bridge_VulkanBridge_vkSwapchainAcquireFrame(JNIEnv *env, jclass,
...
JNIEXPORT jlong JNICALL
Java_io_materia_gpu_bridge_VulkanBridge_vkCreateBuffer(JNIEnv *env, jclass, jlong instanceId,
...
Java_io_materia_gpu_bridge_VulkanBridge_vkWriteBuffer(JNIEnv *env, jclass, jlong instanceId,
...
JNIEXPORT void JNICALL
Java_io_materia_gpu_bridge_VulkanBridge_vkWriteBufferFloats(JNIEnv *env, jclass, jlong instanceId,
                                                            jlong deviceId, jlong bufferId,
...
JNIEXPORT jlong JNICALL
Java_io_materia_gpu_bridge_VulkanBridge_vkCreateShaderModule(JNIEnv *env, jclass, jlong instanceId,
                                                             jlong deviceId,
...
JNIEXPORT jlong JNICALL
Java_io_materia_gpu_bridge_VulkanBridge_vkCreateSampler(JNIEnv *env, jclass, jlong instanceId,
...
JNIEXPORT jlong JNICALL
Java_io_materia_gpu_bridge_VulkanBridge_vkCreateTexture(JNIEnv *env, jclass, jlong instanceId,
...
JNIEXPORT jlong JNICALL
Java_io_materia_gpu_bridge_VulkanBridge_vkCreateTextureView(JNIEnv *env, jclass, jlong instanceId,
...
JNIEXPORT jlong JNICALL
Java_io_materia_gpu_bridge_VulkanBridge_vkCreateBindGroupLayout(JNIEnv *env, jclass,
                                                                jlong instanceId, jlong deviceId,
                                                                jintArray bindings,
...
JNIEXPORT jlong JNICALL
Java_io_materia_gpu_bridge_VulkanBridge_vkCreateBindGroup(JNIEnv *env, jclass, jlong instanceId,
...
JNIEXPORT jlong JNICALL
Java_io_materia_gpu_bridge_VulkanBridge_vkCreatePipelineLayout(JNIEnv *env, jclass,
                                                               jlong instanceId,
                                                               jlong deviceId,
...
JNIEXPORT jlong JNICALL
Java_io_materia_gpu_bridge_VulkanBridge_vkCreateRenderPipeline(
        JNIEnv *env,
        jclass,
        jlong instanceId,
        jlong deviceId,
...
JNIEXPORT jlong JNICALL
Java_io_materia_gpu_bridge_VulkanBridge_vkCreateCommandEncoder(JNIEnv *env, jclass,
                                                               jlong instanceId,
                                                               jlong deviceId) {
    (void) env;
    std::lock_guard<std::mutex> lock(g_registryMutex);
...
JNIEXPORT void JNICALL
Java_io_materia_gpu_bridge_VulkanBridge_vkCommandEncoderEndRenderPass(JNIEnv *env, jclass,
                                                                      jlong instanceId,
                                                                      jlong deviceId,
...
JNIEXPORT void JNICALL
Java_io_materia_gpu_bridge_VulkanBridge_vkCommandEncoderSetPipeline(JNIEnv *env, jclass,
                                                                    jlong instanceId,
                                                                    jlong deviceId,
                                                                    jlong encoderId,
                                                                    jlong pipelineId) {
...
JNIEXPORT void JNICALL
Java_io_materia_gpu_bridge_VulkanBridge_vkCommandEncoderSetVertexBuffer(JNIEnv *env, jclass,
                                                                        jlong instanceId,
                                                                        jlong deviceId,
...
JNIEXPORT void JNICALL
Java_io_materia_gpu_bridge_VulkanBridge_vkCommandEncoderSetIndexBuffer(JNIEnv *env, jclass,
                                                                       jlong instanceId,
                                                                       jlong deviceId,
                                                                       jlong encoderId,
                                                                       jlong bufferId,
...
JNIEXPORT void JNICALL
Java_io_materia_gpu_bridge_VulkanBridge_vkCommandEncoderSetBindGroup(JNIEnv *env, jclass,
                                                                     jlong instanceId,
                                                                     jlong deviceId,
                                                                     jlong encoderId,
                                                                     jint index,
...
JNIEXPORT void JNICALL
Java_io_materia_gpu_bridge_VulkanBridge_vkCommandEncoderDraw(JNIEnv *env, jclass, jlong instanceId,
...
JNIEXPORT void JNICALL
Java_io_materia_gpu_bridge_VulkanBridge_vkCommandEncoderDrawIndexed(JNIEnv *env, jclass,
                                                                    jlong instanceId,
                                                                    jlong deviceId,
                                                                    jlong encoderId,
                                                                    jint indexCount,
...
JNIEXPORT jlong JNICALL
Java_io_materia_gpu_bridge_VulkanBridge_vkCommandEncoderFinish(JNIEnv *env, jclass,
                                                               jlong instanceId,
                                                               jlong deviceId, jlong encoderId) {
    (void) env;
    std::lock_guard<std::mutex> lock(g_registryMutex);
...
JNIEXPORT void JNICALL
Java_io_materia_gpu_bridge_VulkanBridge_vkQueueSubmit(JNIEnv *env, jclass, jlong instanceId,
...
JNIEXPORT void JNICALL
Java_io_materia_gpu_bridge_VulkanBridge_vkDestroyCommandBuffer(JNIEnv *env, jclass,
                                                               jlong instanceId,
                                                               jlong deviceId,
                                                               jlong commandBufferId) {
    (void) env;
...
JNIEXPORT void JNICALL
Java_io_materia_gpu_bridge_VulkanBridge_vkDestroyCommandEncoder(JNIEnv *env, jclass,
                                                                jlong instanceId, jlong deviceId,
                                                                jlong encoderId) {
    (void) env;
    std::lock_guard<std::mutex> lock(g_registryMutex);
...
JNIEXPORT void JNICALL
Java_io_materia_gpu_bridge_VulkanBridge_vkDestroySwapchain(JNIEnv *env, jclass, jlong instanceId,
                                                           jlong deviceId, jlong surfaceId,
                                                           jlong swapchainId) {
    (void) env;
    std::lock_guard<std::mutex> lock(g_registryMutex);
...
JNIEXPORT void JNICALL
Java_io_materia_gpu_bridge_VulkanBridge_vkDestroySurface(JNIEnv *env, jclass, jlong instanceId,
                                                         jlong surfaceId) {
    (void) env;
    std::lock_guard<std::mutex> lock(g_registryMutex);
...
JNIEXPORT void JNICALL
Java_io_materia_gpu_bridge_VulkanBridge_vkDestroyDevice(JNIEnv *env, jclass, jlong instanceId,
                                                        jlong deviceId) {
    (void) env;
    std::lock_guard<std::mutex> lock(g_registryMutex);
    materia::vk::destroyDevice(
            static_cast<std::uint64_t>(instanceId),
            static_cast<std::uint64_t>(deviceId)
    );
}
...
JNIEXPORT void JNICALL
Java_io_materia_gpu_bridge_VulkanBridge_vkDestroyInstance(JNIEnv *env, jclass, jlong instanceId) {
    (void) env;
    std::lock_guard<std::mutex> lock(g_registryMutex);
    materia::vk::destroyInstance(static_cast<std::uint64_t>(instanceId));
}

JNIEXPORT void JNICALL
Java_io_materia_gpu_bridge_VulkanBridge_vkDestroyAll(JNIEnv *env, jclass) {
    (void) env;
    std::lock_guard<std::mutex> lock(g_registryMutex);
