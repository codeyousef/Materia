        ...
        rigidBodies.forEach { body ->
            if (body.bodyType == RigidBodyType.DYNAMIC) {
                ...
                body.angularVelocity =
                    body.angularVelocity.times(1f - body.angularDamping * deltaTime)
            }
        }
...
class AndroidBasicBoxShape(override val halfExtents: Vector3) : AndroidBasicCollisionShape(),
    BoxShape {
...
class AndroidBasicSphereShape(override val radius: Float) : AndroidBasicCollisionShape(),
    SphereShape {
...
class AndroidBasicCylinderShape(override val halfExtents: Vector3) : AndroidBasicCollisionShape(),
    CylinderShape {
...
class AndroidBasicConvexHullShape(override val vertices: FloatArray) : AndroidBasicCollisionShape(),
    ConvexHullShape {
