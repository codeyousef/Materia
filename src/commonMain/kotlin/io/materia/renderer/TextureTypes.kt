...
import io.materia.renderer.Texture as BaseTexture
...
class CubeTextureImpl(
...
) : io.materia.renderer.CubeTexture {
    override val id: Int = generateId()
    val name: String = textureName
    override var needsUpdate: Boolean = true
    var version: Int = 0
    ...
    fun getFaceFloatData(face: CubeFace, mip: Int = 0): FloatArray? =
        faces[face.ordinal][mip]?.copyOf()
