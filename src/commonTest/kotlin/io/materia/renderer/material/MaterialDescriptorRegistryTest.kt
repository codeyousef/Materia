...
import io.materia.renderer.shader.ShaderChunkRegistry
...
class MaterialDescriptorRegistryTest {
    ...
    fun basicDescriptorAvailable() {
        ...
        assertEquals(
            MaterialDescriptorRegistry.sharedUniformBlock.sizeBytes,
            MaterialDescriptorRegistry.uniformBlockSizeBytes()
        )
    ...
    fun standardDescriptorRequiresEnvironmentBinding() {
        ...
        assertEquals(
            setOf(2),
            descriptor.bindingGroups(MaterialBindingSource.ENVIRONMENT_PREFILTER)
        )
    ...
    fun resolveAppliesAlphaBlending() {
        ...
        assertEquals(
            false,
            resolved.renderState.depthWrite,
            "Depth write should be disabled for blended materials"
        )
    }
