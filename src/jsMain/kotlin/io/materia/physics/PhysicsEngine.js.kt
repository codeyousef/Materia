...
class JsBasicCylinderShape(override val halfExtents: Vector3) : JsBasicCollisionShape(),
    CylinderShape {
...
class JsBasicConvexHullShape(override val vertices: FloatArray) : JsBasicCollisionShape(),
    ConvexHullShape {
...
class JsBasicRigidBody(
    ...
    override val id: String = (js("Math.random().toString(36).substr(2, 9)") as? String)
        ?: "id_${kotlin.random.Random.nextInt()}"
