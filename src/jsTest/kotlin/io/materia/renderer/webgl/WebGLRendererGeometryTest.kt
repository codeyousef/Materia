...
class WebGLRendererGeometryTest {
    ...
    fun testIndexedGeometryRendering() = runTest {
        ...
        assertTrue(
            stats.triangles == 12,
            "Expected 12 triangles from indexed cube, got ${stats.triangles}"
        )
    ...
    fun testNonIndexedGeometryRendering() = runTest {
        ...
        assertTrue(
            stats.triangles == 2,
            "Expected 2 triangles from non-indexed quad, got ${stats.triangles}"
        )
    ...
    fun testEmptySceneRendering() = runTest {
        ...
        assertTrue(
            stats.triangles == 0,
            "Expected 0 triangles from empty scene, got ${stats.triangles}"
        )
