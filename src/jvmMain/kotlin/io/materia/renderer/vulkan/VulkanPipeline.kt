...
class VulkanPipeline(
    ...
    fun createPipeline(
        ...
        return try {
            val vertexSpv =
                compileShader(vertexSource, Shaderc.shaderc_glsl_vertex_shader, "triangle.vert")
            val fragmentSpv =
                compileShader(fragmentSource, Shaderc.shaderc_glsl_fragment_shader, "triangle.frag")
    ...
    private fun createGraphicsPipeline(
        ...
        return MemoryStack.stackPush().use { stack ->
            ...
            val bindingDescriptions =
                VkVertexInputBindingDescription.calloc(vertexLayouts.size, stack)
            val attributeCount = vertexLayouts.sumOf { it.attributes.size }
            val attributeDescriptions =
