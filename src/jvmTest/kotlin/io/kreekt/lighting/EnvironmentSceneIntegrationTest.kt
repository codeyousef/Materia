...
class EnvironmentSceneIntegrationTest {
    ...
    fun processEnvironmentPipelinePopulatesScene() {
        runBlocking {
            ...
            assertSame(maps.prefilter, scene.environment, "Scene should reference the generated prefilter map")
            assertSame(maps.brdfLut, scene.environmentBrdfLut, "Scene should reference the generated BRDF LUT")
