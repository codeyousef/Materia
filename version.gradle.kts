// Version management for Materia
...
val groupIdRaw = versionProps.getProperty("GROUP") ?: "codes.yousef"
val artifactIdRaw = versionProps.getProperty("ARTIFACT_ID") ?: "materia"

val versionName = sanitize(versionNameRaw, "0.0.0")
val groupId = sanitize(groupIdRaw, "codes.yousef")
val artifactId = sanitize(artifactIdRaw, "materia")
